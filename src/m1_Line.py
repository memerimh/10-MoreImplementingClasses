...
# ----------------------------------------------------------------------
# TOO: 2. With your instructor, READ THE INSTRUCTIONS
...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.cloned = 0
        self.initstart = Point(start.x,start.y)
        self.initend = Point(end.x,end.y)
        self.prevstart = Point(start.x,start.y)
        # --------------------------------------------------------------
        # TODOo: 3.
